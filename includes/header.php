<?php
    ...
    require(PLUGIN_DIR."includes/pdf.php");
...
<label for="btn-modal" type="button" class='page-title-action'>Añadir Nueva</label>
...
<div class="tablenav top">	
    <div class="alignleft actions bulkactions"> 
        <form method="post" action="#">
            ...
            <input type="submit" formaction="<?php echo PLUGIN_DIR_URL.'includes/csv.php?title='.$title ?>" name="csv" class="button action" value="Descargar CSV">
        </form>
    </div>		
</div>
<br>
